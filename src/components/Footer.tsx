      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              <img src="/lovable-uploads/0d76c7b6-2643-47e3-9f6b-cdc4815848eb.png" alt="DevHelp Logo" className="h-10 w-auto mb-5 dark:hidden" />
              <img src="/lovable-uploads/3190bd35-ca13-432f-bf28-f86c245d7cf5.png" alt="DevHelp Logo" className="h-10 w-auto mb-5 hidden dark:block" />
            </div>
